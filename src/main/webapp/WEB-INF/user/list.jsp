...
<c:forEach items="${LIST}" var="user" >
		<tr bgcolor="#ffffff" onMouseOut="this.bgColor='#ffffff'" onMouseOver="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" href="userget.do?id=${user.id} ">修改</a> | <a class="pn-opt"  
			 onClick="if(!confirm('是否删除数据?')){return false;}"
			 href="delete.do?id=${user.id}">删除</a>
			</td>
		</tr>
</c:forEach>		
...
<div style="margin-top:15px;">
	<input class="del-button" type="submit" value="删除" onClick="optDelete();"/>
</div>
</form>
	...
	<a href="list.do?page=${PAGECONT}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">最后页</a>&nbsp;&nbsp;&nbsp;&nbsp;当前第${PAGE}页 /共${PAGECONT}页</div>
</div>
</body>
</html>